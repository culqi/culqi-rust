...
impl CustomerValidation {
    pub fn create(body: &str,) -> Result<(), CustomException,> {
        ...
        // let phone_number =
        // parsed.get("phone_number").and_then(Value::as_str).
        // ok_or(CustomException::new("Invalid 'phone_number'. It should be a
        // string."))?; Assuming phone_number is always a string in Rust, no
